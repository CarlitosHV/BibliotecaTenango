...
BEGIN
    RETURN QUERY 
    SELECT 
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 AND v.sexo = 'Masculino' THEN 1 ELSE 0 END) AS ArtisticaHombres0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 AND v.sexo = 'Femenino' THEN 1 ELSE 0 END) AS ArtisticaMujeres0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 THEN 1 ELSE 0 END) AS Artistica0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 AND v.sexo = 'Masculino' THEN 1 ELSE 0 END) AS ArtisticaHombres13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 AND v.sexo = 'Femenino' THEN 1 ELSE 0 END) AS ArtisticaMujeres13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 THEN 1 ELSE 0 END) AS Artistica13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 AND v.sexo = 'Masculino' THEN 1 ELSE 0 END) AS ArtisticaHombres18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 AND v.sexo = 'Femenino' THEN 1 ELSE 0 END) AS ArtisticaMujeres18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 THEN 1 ELSE 0 END) AS Artistica18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 AND v.sexo = 'Masculino' THEN 1 ELSE 0 END) AS ArtisticaHombres30a59,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 AND v.sexo = 'Femenino' THEN 1 ELSE 0 END) AS ArtisticaMujeres30a59,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 THEN 1 ELSE 0 END) AS Artistica30a59,
        SUM(CASE WHEN v.edad_visitante >=60 AND v.sexo = 'Masculino' THEN 1 ELSE 0 END) AS ArtisticaHombres60,
        SUM(CASE WHEN v.edad_visitante >=60 AND v.sexo = 'Femenino' THEN 1 ELSE 0 END) AS ArtisticaMujeres60,
