...
BEGIN
    RETURN QUERY 
    SELECT 
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 AND v.sexo = 'Hombre' THEN 1 ELSE 0 END) AS ActividadHombres0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 AND v.sexo = 'Mujer' THEN 1 ELSE 0 END) AS ActividadMujeres0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 0 AND 12 THEN 1 ELSE 0 END) AS Actividades0a12,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 AND v.sexo = 'Hombre' THEN 1 ELSE 0 END) AS ActividadHombres13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 AND v.sexo = 'Mujer' THEN 1 ELSE 0 END) AS ActividadMujeres13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 13 AND 17 THEN 1 ELSE 0 END) AS Actividades13a17,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 AND v.sexo = 'Hombre' THEN 1 ELSE 0 END) AS ActividadHombres18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 AND v.sexo = 'Mujer' THEN 1 ELSE 0 END) AS ActividadMujeres18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 18 AND 29 THEN 1 ELSE 0 END) AS Actividades18a29,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 AND v.sexo = 'Hombre' THEN 1 ELSE 0 END) AS ActividadHombres30a59,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 AND v.sexo = 'Mujer' THEN 1 ELSE 0 END) AS ActividadMujeres30a59,
        SUM(CASE WHEN v.edad_visitante BETWEEN 30 AND 59 THEN 1 ELSE 0 END) AS Actividades30a59,
        SUM(CASE WHEN v.edad_visitante >=60 AND v.sexo = 'Hombre' THEN 1 ELSE 0 END) AS ActividadHombres60,
        SUM(CASE WHEN v.edad_visitante >=60 AND v.sexo = 'Mujer' THEN 1 ELSE 0 END) AS ActividadMujeres60,
